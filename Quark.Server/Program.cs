...
var database = builder.Configuration["Database"] ?? "Endurance";
var connectionString = $"Server={server},{port};Initial Catalog={database};User ID={builder.Configuration["DbUser"]};Password={builder.Configuration["DbPassword"]}";
