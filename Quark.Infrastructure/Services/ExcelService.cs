...
{
    public async Task<string> ExportAsync<TData>(IEnumerable<TData> data, Dictionary<string, Func<TData, object>> mappings, string sheetName = "Sheet1", CancellationToken cancellationToken = new CancellationToken())
    {
        ...
        using (var p = new ExcelPackage())
        {
            ...
            var byteArray = await p.GetAsByteArrayAsync(cancellationToken);
